...
<div class="card"><div class="card-body"><h4 class="card-title">Edit Tracking</h4>
<form method="POST" action="{{ route('shipment-trackings.update', $shipmentTracking) }}">@csrf @method('PUT')
